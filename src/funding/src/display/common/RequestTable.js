...
const RequestTable = (props) => {
    ...
    let {requests, handleApprove, pageKey, handleFinalize, supportersCount} = props
...
let RowInfo = (props) => {
    ...
    let {request, handleApprove1, index, pageKey, handleFinalize, supportersCount} = props
    let {0: purpose, 1: cost, 2: seller, 3: approveCount, 5: status} = request
    ...
    // console.log(purpose, cost, seller, approveCount, supportersCount, status, statusInfo)
    ...
    return (
        <Table.Row>
            ...
            <Table.Cell>{approveCount}/{supportersCount}</Table.Cell>
